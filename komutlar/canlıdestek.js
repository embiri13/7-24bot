...
const emoji = message.client.emojis.get('📞');
      ...
      let destekKanal = "495571453916479506";
    ...
    client.channels.get(destekKanal).send('** Destek Çagrısı Bağlanmak İçin** `bağlan` **Yazınız. İptal Etmek İçin** `iptal` **Yazınız.**')
